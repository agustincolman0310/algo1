...
/* 
 *Inicializará el juego configurado, cargando toda la información inicial, los datos del personaje, y los 3 niveles.
 */
void inicializar_juego_config(juego_t * juego, obstaculos_t obstaculos[MAX_NIVELES], herramientas_t herramientas_t[MAX_NIVELES]);
